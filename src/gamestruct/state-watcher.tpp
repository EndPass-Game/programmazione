...
class StateWatcher {
  private:
    ...
    /**
     * @brief È true solo se last_ non ha un valore, cioè quando l'oggetto è
  ...
  public:
    /**
     * @brief Questo costruttore inizializza solo il valore corrente
    ...
    /**
     * @brief Questo costruttore permette di inizializzare sia il valore corrente
    ...
    /**
     * @return vero solo se è la classe non ha un vecchio valore last_
     */
    bool isFirstValue();
